...
INSERT INTO SALES (ITEM, QUANTITY, AMOUNT) VALUES ('Moka coffee pot By Michellotti', 1, 800.23);
--rollback DELETE FROM SALES WHERE ITEM='Moka coffee pot By Michellotti';
